...
export default function Nav() {
  ...
  return (
    <Navbar className="mx-auto max-w-screen-xl  px-4 py-2 lg:px-8 lg:py-4 text-black flex flex-col justify-center item-center ">
      ...
      <Collapse open={openNav}>
        <div className={`container  ${hidden} mx-auto`}>{navList}</div>
      </Collapse>
    </Navbar>
  );
}
